...
#if 0
  // Hack for WII controls
  // TODO: Factor this out into its own Joystick implementation
  u32 held = WPAD_ButtonsHeld( myJack == Right );
  u32 gcHeld = PAD_ButtonsHeld( myJack == Right );
  myDigitalPinState[One]   = !( held & WII_BUTTON_ATARI_UP || gcHeld & GC_BUTTON_ATARI_UP );
  myDigitalPinState[Two]   = !( held & WII_BUTTON_ATARI_DOWN || gcHeld & GC_BUTTON_ATARI_DOWN );
  myDigitalPinState[Three] = !( held & WII_BUTTON_ATARI_LEFT || gcHeld & GC_BUTTON_ATARI_LEFT );
  myDigitalPinState[Four]  = !( held & WII_BUTTON_ATARI_RIGHT || gcHeld & GC_BUTTON_ATARI_RIGHT );
  myDigitalPinState[Six]   = !( held & WII_BUTTON_ATARI_FIRE || gcHeld & GC_BUTTON_ATARI_FIRE );
#endif
